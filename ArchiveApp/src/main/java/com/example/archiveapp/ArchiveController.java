...
public class ArchiveController implements Initializable {
    ...
    //These will be updated into observable arrays for entries
        ...
        if (file != null) {
            try {
                ...
                while(scanner.hasNextLine()){
                    itemDesc.appendText(scanner.nextLine()+ "\n");
                }
    ...
    void save(ActionEvent event) {
        ...
        if (file != null) {
            saveSystem(file, itemDesc.getText());
            saveSystem(file, itemAge.getText());
            saveSystem(file, itemType.getText());
            saveSystem(file,itemName.getText());
        }
    }
    @FXML
    ...
    @FXML
        ...
        "Horrmann Brewing Co", "Grand Union Tea Co", "Daddies Sauce", "Mid Script Coke", "Dandy Flask", "Lime Cola"};
